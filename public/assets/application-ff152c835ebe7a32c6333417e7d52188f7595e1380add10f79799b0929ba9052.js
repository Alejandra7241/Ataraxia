    ...
    if(array_prerequisites.length == 0){
        ...
        for (index = 0; index < array_of_subjects.length; ++index) {
            var current_subject = array_of_subjects[index].split(",");
                ...
                $('#tablePrerrequisitosSubjectModal > tbody:last-child').append( firsttr + '<tr><td>' + current_code+ '</td><td>' + current_name + '</td><td class="text-right">' + current_typology  + '</td><td> ' + postLink + '</td></tr>');
        }
    }
