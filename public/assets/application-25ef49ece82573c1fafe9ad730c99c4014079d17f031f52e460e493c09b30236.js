...
function modal_for_subject(){
    console.log("Ha!");

    $('#editingSubjectsi').on('shown.bs.modal', function (e){
   ...
   $(document).on('#editingSubjectsi').on('shown.bs.modal', function (e){
    alert("I want this to appear after the modal has opened!");
});


    $(document).on('#editingSubjectsii').on('shown.bs.modal', function (e){
    alert("I want this to appear after the modal has opened!");
});
