...
function searchSubject(name,code,typology){
    ...
    $('#tableQuery > tbody:last-child').append(' <tr><td>' + name+ '</td><td>' + code + '</td><td class="text-right">' + typology  + '</td><td> zsfsaf' + postLink + '</td></tr>');
    }else{
        //document.getElementById("jschange").innerHTML = 'No se han encontrado materias con ese código';
        document.getElementById("jschange").innerHTML = postLink;
    }
    ...
    $('#tableQueryPrerrequisitos > tbody:last-child').append(' <tr><td>' + name+ '</td><td>' + code + '</td><td class="text-right">' + typology  + '</td><td> safasfsa' + postLink + '</td></tr>');
    }else{
        //document.getElementById("jschangeii").innerHTML = 'No se han encontrado materias con ese código';
        document.getElementById("jschangeii").innerHTML = postLink;
    }
}
