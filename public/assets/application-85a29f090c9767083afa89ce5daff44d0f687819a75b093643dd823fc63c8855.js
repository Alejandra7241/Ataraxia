...
function modal_for_subject(code,name,credits,typology, array_prerequisites){
    ...
    document.getElementById("subjectData").innerHTML += '<h3 class = "text-left"><b>Materia: </b></h3> ' + name + '<br>' + '<h3 class = "text-left"><b>Código: </b></h3> ' + code + '<br>' + '<h3 class = "text-left"><b>Creditos: </b></h3>' + credits + '<br>'+ '<h3 class = "text-left"><b>Tipología: </b></h3>' + typology ;
