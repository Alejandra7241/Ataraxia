...
;
      ...
      function getPAPA(ponderacion, creditos_totales){
          ...
          else if(nota_requerida > 5){document.getElementById("pappineeded").innerHTML='<h4><b>¡Lo sentimos! </b> Nunca obtendrás ese P.A.P.A. <br> Necesitarias'+ nota_requerida.toFixed(2) + ' en tu PAPPI. </h4>';}
