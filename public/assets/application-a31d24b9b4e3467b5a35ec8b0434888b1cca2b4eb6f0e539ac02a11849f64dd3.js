...
;
      ...
      function getPAPA(ponderacion, creditos_totales){
          ...
          else if(nota_requerida > 5){document.getElementById("pappineeded").innerHTML='<h4><b>¡Felicidades! </b> Ese P.A.P.A es insubible. Necesitarias '+ nota_requerida.toFixed(2); + ' para subirlo. </h4>';}
          else {document.getElementById("pappineeded").innerHTML='<h4><b>¡Felicidades! </b> Ese P.A.P.A es inbajable. Necesitarias '+ nota_requerida.toFixed(2); + ' para bajarlo. </h4>';}
        }
;
(function() {
