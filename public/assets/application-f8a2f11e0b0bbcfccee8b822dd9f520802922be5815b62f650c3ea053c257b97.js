...
function modal_for_subject(name){
    console.log(name);
...
function searchSubject(name,code,typology){
    ...
    $('#tableQuery > tbody:last-child').append(' <tr><td>' + name+ '</td><td>' + code + '</td><td class="text-right">' + typology  + '</td><td><%= link_to "<p class=\'glyphicon glyphicon-log-in\' style= \'font-size: 60px;\' \'></p>".html_safe, subject %></td></tr>');
    }else{
