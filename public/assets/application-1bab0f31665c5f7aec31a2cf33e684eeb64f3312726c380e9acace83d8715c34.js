...
function modal_for_subject(code,name,credits,typology, array_prerequisites){
    ...
    $('#tablePrerrequisitosSubjectModal > tbody:last-child').append(' <tr><td>' + array_prerequisites[0] + '</td><td>' + array_prerequisites[1] + '</td><td class="text-right">' + array_prerequisites[2]  + '</td><td> ' + postLink + '</td></tr>');
    }else{
