...
function example(name_subject){
    
    document.getElementById("jschange").innerHTML = name_subject;
    $('#tableQuery > tbody:last-child').append(' <tr><td>Long Island, NY, USA</td><td>3</td><td class="text-right">45001</td></tr>');
}
function reset() {
