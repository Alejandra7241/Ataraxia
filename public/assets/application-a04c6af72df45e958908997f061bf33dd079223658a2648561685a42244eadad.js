...
function modal_for_subject(code,name,credits,typology, array_prerequisites){
    ...
    document.getElementById("subjectData").innerHTML = '<h4 class = "text-left"><b>Código: </b>' + code + '</h4>' + '<h4 class = "text-left"><b>Creditos: </b>' + credits + '</h4>' + '<h4 class = "text-left"><b>Tipología: </b>';
    $('#editingSubjectsii').modal('show');
    switch (tipology) {
        case 'B':
            document.getElementById("subjectData").innerHTML += 'Fundamentación</h4>'
            break;
        case 'L':
            document.getElementById("subjectData").innerHTML += 'Electiva</h4>'
            break;
        case 'C':
            document.getElementById("subjectData").innerHTML += 'Disciplinar</h4>'
            break;
        case 'O':
            document.getElementById("subjectData").innerHTML += 'Optativa</h4>'
            break;
        case 'P':
            document.getElementById("subjectData").innerHTML += 'Nivelación</h4>'
            break;
