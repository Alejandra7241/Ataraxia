...
function modal_for_subject(code,name,credits,typology, array_prerequisites){
    ...
    console.log(array_prerequisites.get([0, 0]))
    console.log(array_prerequisites.get([0, 1]))
    console.log(array_prerequisites.get([0, 2]))
    ...
    $('#tablePrerrequisitosSubjectModal > tbody:last-child').append(' <tr><td>' + array_prerequisites[0][0] + '</td><td>' + array_prerequisites[0][1] + '</td><td class="text-right">' + array_prerequisites[0][2]  + '</td><td> ' + postLink + '</td></tr>');
    }else{
...
function searchSubject(name,code,typology){
    ...
    var postLink =  `   <form action="/admin/add_existing_subject" method="post" enctype="multipart/form-data" id="form-product" class="form-horizontal">
                        <button type="submit">
                        <input type="hidden" name="code" id="setCode" value="` + code +`" />
                        <input type="hidden" name="typology" id="setTypology" value="` + typology +`" />
                           <span class="glyphicon glyphicon-ok"></span>
