...
function modal_for_subject(code,name,credits,typology, array_prerequisites){
    ...
    switch (tipology) {
        case 'B':
            ...
            break;
        case 'L':
            document.getElementById("subjectData").innerHTML += '<h4 class = "text-left"><b>Tipología: </b>Electiva</h4>'</h4>';
            break;
        case 'C':
            document.getElementById("subjectData").innerHTML += '<h4 class = "text-left"><b>Disciplinar: </b>Electiva</h4>'</h4>';
            break;
        case 'O':
            document.getElementById("subjectData").innerHTML += '<h4 class = "text-left"><b>Optativa: </b>Electiva</h4>'</h4>';
            break;
        case 'P':
            document.getElementById("subjectData").innerHTML += '<h4 class = "text-left"><b>Nivelación: </b>Electiva</h4>'</h4>';
            break;
