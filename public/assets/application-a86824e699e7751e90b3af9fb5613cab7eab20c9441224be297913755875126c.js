...
function modal_for_subject(code,name,credits,typology, array_prerequisites){
    ...
    switch (typology) {
        ...
        case 'L':
            ...
            break;
        case 'C':
            document.getElementById("subjectData").innerHTML += '<h4 class = "text-left"><b>Disciplinar: </b>Electiva</h4>';
            break;
        case 'O':
            document.getElementById("subjectData").innerHTML += '<h4 class = "text-left"><b>Optativa: </b>Electiva</h4>';
            break;
        case 'P':
            document.getElementById("subjectData").innerHTML += '<h4 class = "text-left"><b>Nivelación: </b>Electiva</h4>';
            break;
    }
    switch (typology) {
        case 'B':
...
function searchSubject(name,code,typology){
    ...
    $('#tableQueryPrerrequisitos > tbody:last-child').append(' <tr><td>' + name+ '</td><td>' + code + '</td><td>' + typology  + '</td><td> ' + postLink + '</td></tr>');
    }else{
