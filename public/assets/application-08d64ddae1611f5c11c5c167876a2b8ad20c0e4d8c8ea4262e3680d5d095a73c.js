...
function modal_for_subject(code,name,credits,typology, array_prerequisites){
    ...
    document.getElementById("subjectData").innerHTML += '<h3 class = "text-left"><b>Materia: </b>' + name + '</h3>' + '<br>' + '<h3 class = "text-left"><b>Código: </b>' + code + '</h3>' + '<br>' + '<h3 class = "text-left"><b>Creditos: </b>' + credits + '</h3>' + '<br>'+ '<h3 class = "text-left"><b>Tipología: </b>' + typology + '</h3>' ;
