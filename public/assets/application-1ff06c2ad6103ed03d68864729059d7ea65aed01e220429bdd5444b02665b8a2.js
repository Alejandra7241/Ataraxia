...
document.getElementById("nameSubjectModalii").innerHTML += name;
document.getElementById("codeSubjectModal").innerHTML += code;
document.getElementById("creditsSubjectModal").innerHTML += credits;
document.getElementById("typologySubjectModal").innerHTML += typology;
...
//$('#editingSubjectsi').modal('hide');
//$('#editingSubjectsii').modal('show');
// $(document).on("click", ".open-editingSubjectsi", function () {
...
// });
    ...
    console.log("Mmm");
// $( "#editingSubjectsi" ).on('shown', function(){
//     alert("I want this to ad!");
// });



// $('#editingSubjectsi').on('show', function(){
...
// });
// $('#editingSubjectsii').on('shown.bs.modal', function (e){
//     alert("I want this to appear after the modal has opened!");
// });



// $( "#editingSubjectsii" ).on('shown', function(){
//     alert("I want this to ad!");
// });



// $('#editingSubjectsii').on('show', function(){
//   alert('The modal is show');
// });
