...
function modal_for_subject(code,name,credits,typology, array_prerequisites){
    ...
    document.getElementById("subjectData").innerHTML += '<h3 class = "text-left"><b>Código: </b>' + code + '</h3>' + '<h3 class = "text-left"><b>Creditos: </b>' + credits + '</h3>' +  '<h3 class = "text-left"><b>Tipología: </b>' + typology + '</h3>' ;
    ...
    if(array_prerequisites.length == 0){
        document.getElementById("jschangeiii").innerHTML = '<t>      Esta materia aún no tiene prerequisitos, agregalos abajo.';   
    }else{
