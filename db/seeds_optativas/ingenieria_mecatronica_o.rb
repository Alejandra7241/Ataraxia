...
subj = Subject.create({code: 1000018, name: 'Fundamentos de física moderna', credits: 3})
chs_materia = CareerHasSubject.create( :subject => subj, :typology => 'B', :career => career)
chs_materia.followers << [
    # Ecuaciones diferenciales
    CareerHasSubject.find_by(career_id: career.id, subject_id: Subject.find_by_code(1000007).id)
...
subj_opt = Subject.create({code:25480001, name: 'Física', credits: -2})
...
subj_opt = Subject.create({code:25480002, name: 'Procesos de Manufactura', credits: -2})
chs_opt = CareerHasSubject.create( :subject => subj_opt, :typology => 'O', :career => career)
chs_opt.available << [
...
subj = Subject.create({code: 2015942, name: 'Aplicaciones de elementos finitos', credits: 3})
chs_materia = CareerHasSubject.create( :subject => subj, :typology => 'B', :career => career)
chs_materia.followers << [
    # Ecuaciones diferenciales
    CareerHasSubject.find_by(career_id: career.id, subject_id: Subject.find_by_code(1000007).id)
...
subj_opt = Subject.create({code:25480003, name: 'Herramientas para ingeniería', credits: -2})
chs_opt = CareerHasSubject.create( :subject => subj_opt, :typology => 'O', :career => career)
chs_opt.available << [
...
subj_opt = Subject.create({code:25480004, name: 'Ciencias económicas y administrativas', credits: -2})
chs_opt = CareerHasSubject.create( :subject => subj_opt, :typology => 'O', :career => career)
chs_opt.available << [
...
# Técnicas de control
subj = Subject.create({code: 2022888, name: 'Técnicas de control', credits: 3})
chs_materia = CareerHasSubject.create( :subject => subj, :typology => 'C', :career => career)
chs_materia.followers << [
    # control
...
subj = Subject.create({code: 2017290, name: 'écnicas de Inteligencia Artificial', credits: 3})
chs_materia = CareerHasSubject.create( :subject => subj, :typology => 'C', :career => career)
chs_materia.followers << [
    # control
    CareerHasSubject.find_by(career_id: career.id, subject_id: Subject.find_by_code(2016493).id)
...
subj_opt = Subject.create({code:25480005, name: 'Herramientas para automatización de procesos', credits: -2})
chs_opt = CareerHasSubject.create( :subject => subj_opt, :typology => 'O', :career => career)
chs_opt.available << [
