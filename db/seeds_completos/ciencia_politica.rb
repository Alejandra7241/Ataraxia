...
#---------- Malla estándar Ciencia Política ----------#

career = Career.create({code: 2538, name: 'Ciencia Política', department: 'Departamento de Ciencia Política', faculty: 'Derecho, ciencias políticas y sociales'})
...
subj = Subject.find_by(code: 2015202)
chs = CareerHasSubject.create( :subject => subj, :typology => 'B')
career.career_has_subjects << chs
sem.career_has_subjects << chs
#Historia politica moderna
subj = Subject.find_by(code: 2015192)
chs = CareerHasSubject.create( :subject => subj, :typology => 'B')
career.career_has_subjects << chs
sem.career_has_subjects << chs
#Historia politica y socieconómica de colombia del s. xix
subj = Subject.find_by(code: 2015190)
chs = CareerHasSubject.create( :subject => subj, :typology => 'B')
career.career_has_subjects << chs
sem.career_has_subjects << chs
#Introduccion a la ciencia politica
subj = Subject.find_by(code: 2015194)
chs = CareerHasSubject.create( :subject => subj, :typology => 'B')
career.career_has_subjects << chs
sem.career_has_subjects << chs
...
#Teorías del estado
subj = Subject.find_by(code: 2015206)
chs = CareerHasSubject.create( :subject => subj, :typology => 'B')
career.career_has_subjects << chs
sem.career_has_subjects << chs
#Procesos politicos de america latina
subj = Subject.find_by(code: 2015199)
chs = CareerHasSubject.create( :subject => subj, :typology => 'B')
career.career_has_subjects << chs
sem.career_has_subjects << chs
#Historia politica y socieconomica de colombia del s. xx
subj = Subject.find_by(code: 2015191)
chs = CareerHasSubject.create( :subject => subj, :typology => 'B')
career.career_has_subjects << chs
sem.career_has_subjects << chs
...
subj = Subject.find_by(code: 2015209)
chs = CareerHasSubject.create( :subject => subj, :typology => 'C')
career.career_has_subjects << chs
sem.career_has_subjects << chs
#Teorias de las relaciones internacionales
subj = Subject.find_by(code: 2015210)
chs = CareerHasSubject.create( :subject => subj, :typology => 'C')
career.career_has_subjects << chs
sem.career_has_subjects << chs
#Sistemas politicos
subj = Subject.find_by(code: 2015201)
chs = CareerHasSubject.create( :subject => subj, :typology => 'C')
career.career_has_subjects << chs
sem.career_has_subjects << chs
#Economia pública
subj = Subject.find_by(code: 2015187)
chs = CareerHasSubject.create( :subject => subj, :typology => 'C')
career.career_has_subjects << chs
sem.career_has_subjects << chs
#Introducción a la investigación
subj = Subject.find_by(code: 2015195)
chs = CareerHasSubject.create( :subject => subj, :typology => 'C')
career.career_has_subjects << chs
sem.career_has_subjects << chs
...
subj = Subject.find_by(code: 2015208)
chs = CareerHasSubject.create( :subject => subj, :typology => 'C')
career.career_has_subjects << chs
sem.career_has_subjects << chs
#Teorías de la globalización
subj = Subject.find_by(code: 2015205)
chs = CareerHasSubject.create( :subject => subj, :typology => 'C')
career.career_has_subjects << chs
sem.career_has_subjects << chs
#Partidos politicos y sistemas electorales
subj = Subject.find_by(code: 2015198)
chs = CareerHasSubject.create( :subject => subj, :typology => 'C')
career.career_has_subjects << chs
sem.career_has_subjects << chs
#Teorías de la administración pública
subj = Subject.find_by(code: 2015203)
chs = CareerHasSubject.create( :subject => subj, :typology => 'C')
career.career_has_subjects << chs
sem.career_has_subjects << chs
#Métodos cuantitativos y cualitativos
subj = Subject.find_by(code: 2015197)
chs = CareerHasSubject.create( :subject => subj, :typology => 'C')
career.career_has_subjects << chs
sem.career_has_subjects << chs
...
#Teorías del poder
subj = Subject.find_by(code: 2015207)
chs = CareerHasSubject.create( :subject => subj, :typology => 'C')
career.career_has_subjects << chs
sem.career_has_subjects << chs
#Instituciones y derecho internacional público
subj = Subject.find_by(code: 2015193)
chs = CareerHasSubject.create( :subject => subj, :typology => 'C')
career.career_has_subjects << chs
sem.career_has_subjects << chs
#Sistema politico colombiano
subj = Subject.find_by(code: 2015200)
chs = CareerHasSubject.create( :subject => subj, :typology => 'C')
career.career_has_subjects << chs
sem.career_has_subjects << chs
#Gobierno y politicas públicas
subj = Subject.find_by(code: 2015189)
chs = CareerHasSubject.create( :subject => subj, :typology => 'C')
career.career_has_subjects << chs
sem.career_has_subjects << chs
#Metodo y analisis comparado
subj = Subject.find_by(code: 2015196)
chs = CareerHasSubject.create( :subject => subj, :typology => 'C')
career.career_has_subjects << chs
sem.career_has_subjects << chs
...
#Teorias de la cultura política
subj = Subject.find_by(code: 2015204)
chs = CareerHasSubject.create( :subject => subj, :typology => 'C')
career.career_has_subjects << chs
sem.career_has_subjects << chs
...
sem.career_has_subjects << chs
#Trabajo de Grado
subj = Subject.find_by(code: 2015279)
chs = CareerHasSubject.create( :subject => subj, :typology => 'C')
career.career_has_subjects << chs
sem.career_has_subjects << chs
