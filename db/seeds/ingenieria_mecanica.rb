#-------------------------------------------------------------------------------------------
        ...
        #---------- Malla estándar Ingeniería Mecanica ----------#

career = Career.create({code: 2547, name: 'Ingeniería Mecanica', department: 'Departamento de Ingeniería Mecanica y Mecatrónica', faculty: 'Ingeniería'})
...
subj = Subject.find_by(code: 2008643)
chs = CareerHasSubject.create( :subject => subj, :typology => 'B')
career.career_has_subjects << chs
sem.career_has_subjects << chs
