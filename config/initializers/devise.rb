...
Devise.setup do |config|
  ...
  if Rails.env.production?
    ...
    config.secret_key = '6fade12ac0dc80458c887a1e313f490ab8671ba8937a39dd73350141b186f3b307336ca5f65a8580633f041eee024dfc506c8d4e2abb87b03b3b56f6b7cb85be'
  ...
  # config.pepper = '81d2c6633a45d4b945cf1d5d3686a0c4edb7f0e3c1432293782a2ec6dce147343b2bb71626845b99d8822fa60a31eee988f349684fd36090e5e8c21be34073a9'
  ...
  if Rails.env.production?
    ...
    config.omniauth :google_oauth2, Rails.application.secrets.api_google_username, Rails.application.secrets.api_google_secret, {}
    config.omniauth :facebook, Rails.application.secrets.api_facebook_username, Rails.application.secrets.api_facebook_secret
  end
